...
public class MyPhoto {
	...
	public MyPhoto(Context context, List<PhotoInfo> photoList) {
	...
	public Dialog openDetailsDialog(int position) {
		...
		String size = "\t大小：" + MyTools.sizeFormat(photoList.get(position).size)
				+ "\n";
		String date_modified = "\t修改日期："
				+ MyTools.secondsToDate(photoList.get(position).dateModified);
